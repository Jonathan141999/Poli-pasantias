                        ...
                        rules={[
                            {
                                required: true,
                                whitespace: true,
                                message: 'Escriba correctamente las horas a ofertar'
                            }, {
                                // Validacion de un maximo de horas
                                message:'Solo puede ofertar de 100 a 300 horas'
                            }
                        ]}
                        hasFeedback
                    >
                        ...
                        rules={[
                            {
                                required: true,
                                whitespace: true,
                                message: 'Escriba los detalles de la práctica preprofesional'
                            }
                        ]}
                        hasFeedback
                    >
